...
<form class="sfs" action="{{route('sfs_performer_panel')}}" method="get" id="sfs">
...
<div class="pagination_block" id="pagination_block">
    ...
    <div class="numbers_block">
        ...
        @for ($i=1;$i<=$amount;$i++)
            ...
            ?>
            <div class="r1 current_page" style="font-size: 1.1vmax;"><a href="{{route('paginate_performer_panel', $i)}}" style="text-decoration:none; color: inherit;">{{$i}}</a></div>
            ...
            ?>
            <div class="r1"><a href="{{route('paginate_performer_panel', $i)}}" style="text-decoration:none; color: inherit;">{{$i}}</a></div>
